...
public final class ViewTaskListLayoutBinding implements ViewBinding {
  @NonNull
  ...
  private ViewTaskListLayoutBinding(@NonNull MaterialCardView rootView, @NonNull TextView dateTxt,
  ...
  @NonNull
  public static ViewTaskListLayoutBinding inflate(@NonNull LayoutInflater inflater) {
  ...
  public static ViewTaskListLayoutBinding inflate(@NonNull LayoutInflater inflater,
    ...
    View root = inflater.inflate(R.layout.view_task_list_layout, parent, false);
    if (attachToParent) {
      parent.addView(root);
    }
    return bind(root);
  ...
  @NonNull
  public static ViewTaskListLayoutBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new ViewTaskListLayoutBinding((MaterialCardView) rootView, dateTxt, deleteImg,
